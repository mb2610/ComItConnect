...
using ComItConnect.STS.Identity.Configuration;
using ComItConnect.STS.Identity.Configuration.ApplicationParts;
using ComItConnect.STS.Identity.Configuration.Constants;
using ComItConnect.STS.Identity.Configuration.Interfaces;
using ComItConnect.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace ComItConnect.STS.Identity.Helpers
{
